<template>
    ...
    <el-form-item label="电商平台类型：">
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <el-input disabled v-model="form.key"></el-input>
        </el-col>
      </el-row>
    </el-form-item>
    ...
    <el-form-item label="检验方式：" prop="sex">
      <el-row :gutter="20">
        <el-col :span="23">
          <el-radio-group v-model="form.sex">
            <el-radio label="男">默认</el-radio>
            <el-radio label="女">接口采集</el-radio>
          </el-radio-group>
        </el-col>
      </el-row>
    </el-form-item>
  ...
  methods: {
    async setType() {
      ...
      if(!res.data.code) {
        ...
        /* this.form.activeShop = res.data.shopSiteList[0].id */
      }
    },
